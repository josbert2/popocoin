                    ...
                    <div className="container px-4 py-5 mx-auto space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-between lg:space-x-10">
                        ...
                        <div className="flex flex-col space-y-4 lg:hidden" style={{ display: "none" }}>
                            <div className="flex flex-col space-y-3 lg:space-y-0 lg:flex-row lg:space-x-6 xl:space-x-8 lg:items-center">
                                <a href="/" className="text-gray-500 dark:text-gray-200 hover:text-gray-800">Charts</a> 
                                
                                
                                <a href="/premium" className="text-gray-500 dark:text-gray-200 hover:text-gray-800">Multi Chart</a> <a href="/blog" className="text-gray-500 dark:text-gray-200 hover:text-gray-800">Blog</a>
                        ...
                        <div className="hidden lg:flex lg:flex-row lg:items-center lg:justify-between lg:flex-1 lg:space-x-2">
                            <div className="flex flex-col space-y-3 lg:space-y-0 lg:flex-row lg:space-x-6 xl:space-x-8 lg:items-center">
                                ...
                                <a href="/premium" className="text-gray-500 dark:text-gray-200 hover:text-gray-800">Multi Chart</a> 
                                <a href="/blog" className="text-gray-500 dark:text-gray-200 hover:text-gray-800">About</a>
